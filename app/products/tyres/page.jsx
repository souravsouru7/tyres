  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        console.log("Tyres API Response:", response);
      ...
      <div className="relative min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
        ...
        <div className="relative py-16 mb-12">
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              ...
              >
                Explore our collection of high-quality tyres engineered for superior performance, 
                safety, and durability across various driving conditions.
              </motion.p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 pb-24 relative z-10">
          {loading ? (
            ...
            <div className="text-center py-20">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">No Tyres Available</h3>
              <p className="text-gray-600 mb-8">We couldn't find any tyre products at the moment.</p>
              <Link 
                href="/products" 
                className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg transition-colors"
              >
