      ...
      <div className="relative min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
        ...
        <div className="relative py-16 mb-12">
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              ...
              >
                Discover our collection of premium wheels that combine beautiful design with 
                superior performance to enhance your vehicle's look and handling.
              </motion.p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 pb-24 relative z-10">
          {loading ? (
            ...
            <div className="text-center py-20">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">No Wheels Available</h3>
              <p className="text-gray-600 mb-8">We couldn't find any wheel products at the moment.</p>
              <Link 
                href="/products" 
                className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg transition-colors"
              >
